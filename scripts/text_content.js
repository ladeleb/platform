...
genderText.textAr = {
	...
	desc :'تظهر هذه الخريطة العدد الاجمالي للناخبين الذكور والاناث (الناخبين المسجّلين والمقترعين) في كل دائرة انتخابية في انتخابات 2009 اضافة الى المسجّلين على لوائح 2013 و2014 و2015 و2016 و2017. ان نسبة مشاركة الذكور في انتخابات العام 2009 محتسبة مقارنة بعدد الناخبين الذكور المسجلين على القوائم الانتخابية وكذلك نسبة مشاركة الناخبات الاناث وهذه النسب لم تحتسب بالمقارنة مع مجموع المشاركين في العملية الانتخابيّة.',
	attribution: 'الجمعية اللبنانية من أجل ديمقراطية الإنتخابات',
	select: "اختر خريطة:",
	voter_turnout: "الناخبون حسب المشاركة",
	voter_registration: "الناخبون حسب التسجيل",
...
expatText.textEn = {
	...
	desc : 'The following map shows the total number of the registered voters among Lebanese expatriates in 2017, according to the electoral districts they belong to. The map shows the countries they reside in, alongside their gender, and confession. Green indicates the registered voters among expatriates in a specific district.',
	attribution: 'Data by Lebanese Association for Democratic Elections'
...
expatText.textAr = {
	...
	desc :'تُظهِر هذه الخريطة عدد الناخبين الذين سجّلوا أسماءهم لدى السفارات والقنصليّات في بلدان الاغتراب للعام 2017، بحسب الدوائر الانتخابية التي ينتمون إليها، بالإضافة إلي البلدان التي يتواجدون فيها، نسبة النساء والرجال فيما بينهم، إضافة إلى طوائفهم. يرمز اللون الأخضر إلى الدوائر التي تسجل فيها اللبنانيون في الاغتراب. ',
	attribution: 'الجمعية اللبنانية من أجل ديمقراطية الإنتخابات'
};
