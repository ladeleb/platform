...
confessions.textAr = {
	title : 'الناخبين المسجلون حسب الطائفة',
...
genderText.textAr = {
	title : 'الناخبين المسجلون حسب الجنس',
	desc :'تظهر هذه الخريطة العدد الاجمالي للناخلين الذكور والاناث ( الناخلين المسجلين والمقترعين) في كل دائرة انتخابية في انتخابات 2009. اللون الأخضر يشير إلى أنّ عدد الذكور أكبر من عدد الإناث (سواء كانوا أعداد الناخبين المسجلين أم المقترعين). اللون الزهري يشير إلى أنّ عدد الإناث أكبر من عدد الذكور',
	attribution: 'الجمعية اللبنانية من أجل ديمقراطية الإنتخابات',
	select: ":اختر خريطة",
