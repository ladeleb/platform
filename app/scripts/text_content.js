...
whiteBallotText.textAr = {
	title : 'قوة <fh>الاقتراع صوت أبيض</fh>',
	desc : ' تظهر هذه الخريطة عدد الأوراق البيضاء وعدد الأوراق غير المحتسبة (الملغاة) في كل دائرة انتخابيّة بالنسبة لجميع الانتخابات النيابية. والمتفق عليه أن الورقة البيضاء ترمز إلى رفض القانون الانتخابي أو المرشحين. ',
	select: ":اختر خريطة",
	...
	content: [
		...
		{
			ttime : '2009',
			time_desc : 'الأصوات الباطلة عام 2009'
			// need to add map layer
		},
		{
			ttime : '2009',
			time_desc : 'الأصوات البيضاء عام 2009'
		}
...
powerText.textAr = {
	title : 'مساواة التمثيل بين الناخبين',
